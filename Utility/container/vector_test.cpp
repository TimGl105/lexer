...
int main() {
	...
	if (str_ult.contains("-1")) {
		str_ult.insert(str_ult.rend() + 1, str_ult.rbegin() + 1, str_ult.rend() - 1);
	}
	...
	mill_vec.insert(mill_vec_std.begin(), p4_vec_std.begin(), p4_vec_std.end());
	mill_vec.insert(mill_vec_std.begin(), p3_vec_std.begin(), p3_vec_std.end());
	mill_vec.insert(mill_vec_std.begin(), p1_vec_std.begin(), p1_vec_std.end());
	mill_vec.insert(mill_vec_std.begin() + 250000, p2_vec_std.begin(), p2_vec_std.end());
}
