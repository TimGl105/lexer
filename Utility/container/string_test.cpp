...
void test_out(const char* asserted, String& test_string) { 
	std::cout << "Asserted:" << asserted << " " << std::endl; 
...
int main() {
	...
	String str_part = str_const[2];
	test_out("nst", str_part);
	
	String str_index(str_1);
	std::cout << str_index[3] << std::endl;
	String str_part2 = str_index[3];
	test_out("dtwice", str_part2);
	std::cout << str_index[5] << std::endl;
	String str_part3 = str_index[5];
	test_out("wice", str_index[5]);
	std::cout << str_index[6] << std::endl;
	String str_part4 = str_index[9];
	test_out("", str_index[9]);
